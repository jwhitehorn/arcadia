...
public class ArcadiaParser extends Parser {
	...
	public static final int
		...
		RULE_initial_array_assignment = 45, RULE_array_assignment = 46, RULE_array_definition = 47, 
		RULE_array_definition_elements = 48, RULE_array_selector = 49, RULE_dynamic_result = 50, 
		RULE_dynamic = 51, RULE_int_result = 52, RULE_float_result = 53, RULE_string_result = 54, 
		...
		RULE_int_t = 63, RULE_bool_t = 64, RULE_nil_t = 65, RULE_r_id = 66, RULE_r_id_global = 67, 
		RULE_r_id_function = 68, RULE_terminator = 69, RULE_else_token = 70, RULE_crlf = 71;
	...
	public static class Initial_array_assignmentContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ArcadiaListener ) ((ArcadiaListener)listener).enterInitial_array_assignment(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ArcadiaListener ) ((ArcadiaListener)listener).exitInitial_array_assignment(this);
		}
	}
	...
	public final Initial_array_assignmentContext initial_array_assignment() throws RecognitionException {
		...
		try {
			...
			{
			setState(510);
			((Initial_array_assignmentContext)_localctx).var_r_id = lvalue();
			setState(511);
	...
	public final R_idContext r_id() throws RecognitionException {
		...
		enterRule(_localctx, 132, RULE_r_id);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(799);
	...
	public final R_id_globalContext r_id_global() throws RecognitionException {
		...
		enterRule(_localctx, 134, RULE_r_id_global);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(801);
	...
	public final R_id_functionContext r_id_function() throws RecognitionException {
		...
		enterRule(_localctx, 136, RULE_r_id_function);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(803);
