...
global_get : var_name=lvalue op=ASSIGN global_name=r_id_global;

global_set : global_name=r_id_global op=ASSIGN result=all_result;

global_result : r_id_global;
...
function_definition_params_list : function_definition_param_r_id
                                | function_definition_params_list COMMA function_definition_param_r_id
                                ;

function_definition_param_r_id : r_id;
...
function_named_param : r_id op=ASSIGN ( int_result | float_result | string_result | dynamic_result );
...
assignment : var_r_id=lvalue op=ASSIGN rvalue
           | var_r_id=lvalue op=( PLUS_ASSIGN | MINUS_ASSIGN | MUL_ASSIGN | DIV_ASSIGN | MOD_ASSIGN | EXP_ASSIGN ) rvalue
           ;

dynamic_assignment : var_r_id=lvalue op=ASSIGN dynamic_result
                   | var_r_id=lvalue op=( PLUS_ASSIGN | MINUS_ASSIGN | MUL_ASSIGN | DIV_ASSIGN | MOD_ASSIGN | EXP_ASSIGN ) dynamic_result
                   ;

int_assignment : var_r_id=lvalue op=ASSIGN int_result
               | var_r_id=lvalue op=( PLUS_ASSIGN | MINUS_ASSIGN | MUL_ASSIGN | DIV_ASSIGN | MOD_ASSIGN | EXP_ASSIGN ) int_result
               ;

float_assignment : var_r_id=lvalue op=ASSIGN float_result
                 | var_r_id=lvalue op=( PLUS_ASSIGN | MINUS_ASSIGN | MUL_ASSIGN | DIV_ASSIGN | MOD_ASSIGN | EXP_ASSIGN ) float_result
                 ;

string_assignment : var_r_id=lvalue op=ASSIGN string_result
...
array_selector : r_id LEFT_SBRACKET ( int_result | dynamic_result ) RIGHT_SBRACKET
               | r_id_global LEFT_SBRACKET ( int_result | dynamic_result ) RIGHT_SBRACKET
               ;
...
r_id_global : R_ID_GLOBAL;

r_id_function : R_ID_FUNCTION;
